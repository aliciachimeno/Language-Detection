...
if __name__ == "__main__":
    ...
    print('Coverage: ', compute_coverage(features, X_test.values, analyzer=args.analyzer)) #How much of the vocab in the train is in te test
    print('========')

    #Apply Classifier  
    X_train, X_test = normalizeData(X_train_raw, X_test_raw)
    y_predict = applyDecisionTrees(X_train, y_train, X_test)
